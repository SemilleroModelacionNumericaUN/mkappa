...
% Sección Circular de concreto reforzado de D=50, con configuración de malla #2
% -----------------------------------------------------------------------------------
...
MAT(1,2) = 101;               % identificador del modelo material
                              ...
                              %     a tensión     
MAT(1,3) = 35;                % f'co resistencia a la compresión inconfinada [MPa]
...
MAT(2,4) = 0.4127;       % dc altura del núcleo [m]
MAT(2,5) = 3.87e-4;      % Asy area total estribos transversales a lo largo de y [m2]
MAT(2,6) = 0.4127;       % bc base del núcleo [m]
...
% -----------------------------------------------------------------------------------
ANA(1) = 34;        % Número de pasos de curvatura
ANA(2) = 0.001;     % Valor del incremento en la curvatura [1/m]
ANA(3) = 0.001;     % Tolerancia del error en la sumatoria de fuerza axial [kN]
ANA(4) = 15;        % Ángulo (theta) definido de la resultante de momentos [0º,360º]
ANA(5) = 0.0001;    % Tolerancia del error del ángulo theta [º]
...
% Bloque de parámetros de análisis numérico
% -----------------------------------------------------------------------------------
ANA(1) = 34;          % Número de incrementos de curvatura
ANA(2) = 0.001;       % Valor de los intervalos de curvatura [1/m]
ANA(3) = 3;           % Número de incrementos de deformación axial    
ANA(4) = 0.0002;      % Valor de los intervalos de deformación axial (+)tensión (-) compres.
ANA(5) = 30;          % Ángulo (theta) de la resultante de momentos [0º,360º]
ANA(6) = 0.0001;      % Tolerancia del error del ángulo theta [º]
ANA(7) = 0.001;       % Tolerancia del error en la sumatoria de fuerza axial [kN]
ANA(8) = 2;           % Posición del punto de aplicación de la carga axial, donde
                        % 1 Centroide 
