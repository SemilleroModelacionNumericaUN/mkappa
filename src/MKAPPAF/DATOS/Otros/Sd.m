...
MAT(2,5) = 2.54e-4;                 %  Asx #4 area total barras transversales a lo largo de x
MAT(2,6) = 0.5;                 %  dc altura del nucleo
MAT(2,7) = 2.54e-4;                 %  Asy #4 area total barras transversales a lo largo de y
MAT(2,8) = 0.3;               %  bc base del nucleo
MAT(2,9) = 0.15;                 %  Separaci�n promedio
