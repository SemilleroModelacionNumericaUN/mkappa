% Función que lee el archivo de datos .msh creado en Gmsh
...
%          NCAT: número de categorías de los elementos
...
%               [ ICAT NUDI NUDJ NUDK ]
%          CAT: tabla de categorías de los elementos
%               [ IDCAT ]
    ...
    if (strcmp(TLINE,'$Elements')==1)
      ...
      for IELT=1:NELT
        ...
        if TEMP(2)==3
          ...
          if ARVO > 0.0
            % nudos en sentido antihorario (correcto)
            % [id entidad física ; id nudos i,j,k,l]
      ...
      if CORL>0
        DUMI = IMTIEM('',0);
        fprintf('\n');
        warning(['LEGMSH: correcciÃ³n de conectividades, ordenando ' ...
