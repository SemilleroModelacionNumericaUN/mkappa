...
% Sección de Acero Rellena de Concreto (SARC o CFST) 20x40, doblemente simétrica
% -----------------------------------------------------------------------------------
...
MAT(1,4) = 3;                 % f't resistencia a la tensión [MPa]
...
MAT(2,11)= 400;          % D Ancho de la sección rectangular o diámetro exterior [mm]
MAT(2,12)= 10;           % t Espesor de la tubería [mm]
...
MAT(3,5) = 0.0125;            % deformación de inicio de endurecimiento
MAT(3,6) = 0.2;               % deformación máxima
MAT(3,7) = 450;               % esfuerzo máximo [MPa]
MAT(3,8) = MAT(3,3)/MAT(3,4); % Deformación de fluencia 
MAT(3,9) = 0.30;              % Relación de Poisson
