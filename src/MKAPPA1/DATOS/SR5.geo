...
//+
Transfinite Curve {25} = 6 Using Progression 1;
//+
Transfinite Curve {18} = 5 Using Progression 1;
//+
Transfinite Curve {17} = 5 Using Progression 1;
//+
Transfinite Curve {26} = 5 Using Progression 1;
//+
Transfinite Curve {19} = 13 Using Progression 1;
//+
Transfinite Curve {22} = 15 Using Progression 1;
//+
Transfinite Curve {21} = 13 Using Progression 1;
//+
Transfinite Curve {20} = 11 Using Progression 1;
//+
Transfinite Curve {24} = 5 Using Progression 1;
//+
Transfinite Curve {15} = 5 Using Progression 1;
//+
Transfinite Curve {14} = 5 Using Progression 1;
//+
Transfinite Curve {23} = 5 Using Progression 1;
