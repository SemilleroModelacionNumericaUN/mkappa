...
% Ángulo de Lados Desiguales, con configuración de malla #2
% -----------------------------------------------------------------------------------
...
MAT(3,5) = 0.100;             % deformación de inicio de endurecimiento
...
% -----------------------------------------------------------------------------------
ANA(1) = 35;          % Número de incrementos de curvatura
ANA(2) = 0.002;       % Valor de los intervalos de curvatura [1/m]
ANA(3) = 1;           % Número de incrementos de deformación axial    
ANA(4) = 0.0005;      % Valor de los intervalos de deformación axial (+)tensión (-) compres.
ANA(5) = 0;          % Ángulo (theta) de la resultante de momentos [0º,360º]
