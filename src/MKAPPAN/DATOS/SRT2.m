...
% Sección Rectangular de concreto reforzado, representada en su Totalidad y 2da malla
% -----------------------------------------------------------------------------------
...
ANA(3) = 10;           % Número de incrementos de deformación axial    
ANA(4) = -0.000055;    % Valor de los intervalos de deformación axial (+)tensión (-) compres.
ANA(5) = 45;          % Ángulo (theta) de la resultante de momentos [0º,360º]
ANA(6) = 0.0001;      % Tolerancia del error del ángulo theta
ANA(7) = 0.001;       % Tolerancia del error en la sumatoria de fuerza axial
...
PX=0; PY=0;             % 4 Punto [PX,PY] definido por el usuario (en metros)
