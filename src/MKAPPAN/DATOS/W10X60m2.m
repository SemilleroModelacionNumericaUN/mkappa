...
ANA(3) = 2;           % Número de incrementos de deformación axial    
ANA(4) = 0.0001;      % Valor de los intervalos de deformación axial (+)tensión (-) compres.
ANA(5) = 10;          % Ángulo (theta) de la resultante de momentos [0º,360º]
